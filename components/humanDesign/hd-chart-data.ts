...
export const HD_CHANNELS: ChartChannel[] = [
  { id: 'c64-47', from: 64, to: 47, name: { zh: '抽象思考通道', en: 'Abstraction'    }, desc: { zh: '你的心智很享受和深奧問題搏鬥，對哲學、歷史、意識這些「太虛」的東西感到真正有趣。你的頓悟通常在放鬆時出現——發呆的瞬間突然就通了；你幫別人解決問題的能力往往比解決自己問題的能力還強。',  en: 'The mental pattern of finding meaning in chaos. Distilling stories from past experiences.' } },
  { id: 'c61-24', from: 61, to: 24, name: { zh: '思想家通道',   en: 'Awareness'      }, desc: { zh: '你的腦袋是一台永遠在轉的思考機器，想要把人生每一件事都搞清楚、都合理化。你的頓悟通常不在用力想的時候出現，而是放鬆的瞬間突然「叮」一聲就通了；你幫別人解決問題的能力往往比解決自己問題的能力還強。',              en: "The thinker's channel. A persistent curiosity about the unknown." } },
  { id: 'c63-4',  from: 63, to: 4,  name: { zh: '邏輯思考通道', en: 'Logic'          }, desc: { zh: '你的腦袋是一台永遠關不掉的分析機器，天生就愛用邏輯拆解問題、推敲可能性。你幫別人解問題往往比解決自己的問題還順手，最重要的功課是在「認真分析」和「享受當下」之間找到平衡。',              en: 'The mental rhythm of doubt and answers. Requires time to verify.' } },
  { id: 'c17-62', from: 17, to: 62, name: { zh: '組織力通道',   en: 'Acceptance'     }, desc: { zh: '你天生善於把各種資訊、事實、細節整合在一起變成有說服力的論點，在需要策略、分析、說服人的場合特別能發揮。但你的腦袋不會停，要學會選擇時機，在真正想清楚且對方需要聽的時候再開口，影響力才能最大化。',              en: "The organizer's channel. Turning opinions into facts and details." } },
  ...
  { id: 'c20-34', from: 20, to: 34, name: { zh: '忙碌通道',     en: 'Charisma'       }, desc: { zh: '當你找到一件真心喜歡的事，你會整個人燃起來，精力充沛停不下來，旁邊的人光看著你就會被帶動。但不是每一件事都值得你去忙——你的能量是真正的資源，只為你愛的事忙才是這條通道最美的狀態。',                  en: 'The present-moment exhibitor. The power of being busy in the now.' } },
  ...
  { id: 'c20-57', from: 20, to: 57, name: { zh: '衝動通道',     en: 'The Brainwave'  }, desc: { zh: '你有一種X光眼，能分辨一個人說的話是不是真心的、一個計畫方向對不對，而且你的話常常是不由自主蹦出來的直覺反應。要練習的不是壓住直覺，而是給直覺一個緩衝——感受到了先在心裡確認，這是說出來的時機嗎？',                        en: 'Intuitive insight in the present moment — instantaneous.' } },
  ...
  { id: 'c10-57', from: 10, to: 57, name: { zh: '生存力通道',   en: 'Perfected Form' }, desc: { zh: '你有一種很難用邏輯解釋的化險為夷能力，脾中心有一套超靈敏的生存雷達，在危險靠近之前就悄悄提醒你。你的直覺靠「聽起來對不對」來判斷，前提是你要願意相信它——壓住直覺，是你最可惜的事。',               en: "Intuition of one's own survival and self-expression." } },
  { id: 'c16-48', from: 16, to: 48, name: { zh: '才華通道',     en: 'The Wavelength' }, desc: { zh: '你對「把事情做好」有一種近乎執著的渴望，天生就有深度，有強烈的動力把自己的才華磨到極致。要小心的陷阱是變成永遠在「準備中」的人——才華需要被使用，不是被囤積，你已經比你以為的更有能力了。',                        en: 'Deep talent expressed through dedicated practice.' } },
  ...
  { id: 'c26-44', from: 26, to: 44, name: { zh: '進取通道',     en: 'Surrender'      }, desc: { zh: '你有一種讓人願意買單的能力，不管是賣產品、推動計畫還是說服別人接受你的想法，你都有辦法讓對方覺得合理並支持你。你同時有商業嗅覺和化解衝突的社交天賦，幫助別人變好的同時也讓自己得到應得的，才是最能持續發光的模式。',                            en: 'Memory, transmission, and commercial instinct.' } },
  ...
  { id: 'c2-14',  from: 2,  to: 14, name: { zh: '煉金士通道',   en: 'The Beat'       }, desc: { zh: '你有一種點石成金的本事，能把搖搖欲墜的爛攤子讓它重新站起來。你有強烈的個人節奏感和財務嗅覺，但要把能量放在真正值得的事上——當你全心投入和你頻率對的事，身邊的人都會被感染、跟著被帶動。',                            en: 'The helmsman of life direction and resources.' } },
  ...
  { id: 'c42-53', from: 42, to: 53, name: { zh: '循環通道',     en: 'Maturation'     }, desc: { zh: '你的人生是一本一本寫完再換下一本的書，成長和改變有週期——工作、感情、居住地、人生方向都會歷經完整的開始、過程和結束。要把心力投注在對的週期裡，在一開始選擇的時候讓直覺帶你選，你的薦骨能量會在你承諾之後把你固定住直到週期走完。',                            en: 'The energy of completing cycles and finding balance.' } },
  ...
  { id: 'c19-49', from: 19, to: 49, name: { zh: '敏感通道',     en: 'Synthesis'      }, desc: { zh: '你對別人的感受靈敏得有點不可思議，光是你在場很多人就覺得安心，你有一種讓人感覺「被照顧到」的能力。但你太容易感受到別人的需求，卻很容易忘記自己也有需求——你要愛自己，才能持續愛別人。',                            en: 'Sensing needs and cultivating sensitivity.' } },
  ...
  { id: 'c6-59',  from: 6,  to: 59, name: { zh: '親密通道',     en: 'Mating'         }, desc: { zh: '你身上有一種天生的吸引力，讓你走進一個場合，人們就會被你吸引過來。這條通道的能量關於連結與創造，你有從無到有的創作力；但在感情上要讓情緒先沉澱，等心裡真的清明了再做決定——不要在情緒最高點的時候做選擇。',                            en: 'The energy of reproduction and breaking down barriers.' } },
  { id: 'c36-35', from: 36, to: 35, name: { zh: '萬事通通道',   en: 'Transitoriness' }, desc: { zh: '你對新鮮感有一種停不下來的渴望，一件事做久了就開始想下一個，你就是需要不斷體驗不斷前進才覺得自己是活著的。你在乎的是過程不是結果，有帶頭體驗人生的本事，很多人跟在你後面才敢去試那些自己不敢試的事。',                            en: 'The jack-of-all-trades seeking all manner of experiences.' } },
  { id: 'c18-58', from: 18, to: 58, name: { zh: '評判通道',     en: 'Judgment'       }, desc: { zh: '你眼睛很利，什麼地方不對勁一眼就看出來，而且通常也知道怎麼解決，非常適合做顧問、評論、稽核這類型的工作。但要注意對家人朋友說出的「建議」，在對方耳裡很可能聽起來像「你哪裡不好」——把批判力用在值得改善的制度或系統上，效果最好。',                            en: 'The energy to challenge and improve the existing order.' } },
